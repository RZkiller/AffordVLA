...
from affordvla.model.tools import read_mode_config
...
class ModelClient:
    def __init__(
        ...
        self._last_mask_probs = None
        self._last_patch_topk = None
    ...
    def step(
        ...
        **kwargs
        ...
        if step % action_chunk_size == 0:
            ...
            self._last_mask_probs = response["data"].get("mask_probs", None)  # [B, V, H_p, W_p] or None
            self._last_patch_topk = response["data"].get("patch_topk", None)  # [B, V, H_p, W_p] or None
        ...
        return {
            ...
            "mask_probs": self._last_mask_probs,
            "patch_topk": self._last_patch_topk,
        }
