...
class TrainerUtils:
    ...
    def save_full_checkpoint(self, completed_steps, checkpoint_dir, output_dir):
        ...
        # Save full accelerator state for all prepared components (optimizer, scheduler, RNG).
        # Skipped when save_optimizer_state=False to save disk space; resume will NOT work.
        ...
        if save_optimizer_state:
            ...
            self.accelerator.print(
                f"⚠️  save_optimizer_state=False: skipping optimizer/scheduler state. "
                f"Resume from this checkpoint will only restore model weights."
            )
        ...
        if self.accelerator.is_main_process:
            ...
            from affordvla.training.trainer_utils.config_tracker import AccessTrackedConfig
