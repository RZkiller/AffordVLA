...
fast_token_list=affordvla/model/modules/vlm/tools/add_qwen_special_tokens/fast_tokens.txt

python affordvla/model/modules/vlm/tools/add_qwen_special_tokens/add_special_tokens_to_qwen.py \
